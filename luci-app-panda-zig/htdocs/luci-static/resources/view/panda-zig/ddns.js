...
function getServiceStatus() {
	return L.resolveDefault(callServiceList('panda-zig'), {}).then(function(res) {
		var isRunning = false;
		try {
			var inst = res['panda-zig']['instances'];
			for (var k in inst) {
...
function renderStatus(isRunning) {
	...
	var text = isRunning ? 'Panda Zig 运行中' : 'Panda Zig 未运行';
